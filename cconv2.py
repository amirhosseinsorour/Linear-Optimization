...
class Conv(Scene):
    ...
    def construct(self):
        ...
        # Introduction
        title = Tex("Continuous Convolution \#2")
        title.scale(2)
        ...
        conv_text = Tex("Continuous Convolution:")
        ...
        # step 1: t -> tau
        t_to_tau = Tex("""$$Step \\ 1: \\; t \\rightarrow \\tau$$""")
        t_to_tau.scale(0.9)
        ...
        htau_to_hmtau = Tex("""$Step \\ 2: \\; h(\\tau) \\rightarrow h(-\\tau)$""")
